...
def build_HOPS_dictionaries(list_lop, list_modes, seed=None):
    ...
    1. list_lop : list(sparse matrix)
                  A list of site-projection operators for the system-bath interaction.
    2. list_modes : list(complex)
                     A list of complex exponential modes in (g, w) form. Assumed
                     here to be the same for all baths.
    3. seed : int
    ...
    # Triangular filtration list
    list_tri_filter = [False, True] * len(list_lop)
...
# Save Timing Data
save_dir = os.getcwd()
data_dir = f'/triangular_filter_timing/nsite-{nsite}/'
