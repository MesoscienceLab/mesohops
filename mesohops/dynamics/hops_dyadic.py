...
class DyadicTrajectory(HopsTrajectory):
    ...
    def __init__(self, system_param, eom_param={}, noise_param={}, hierarchy_param={},
                 storage_param={}, integration_param=None):
        """
        Inputs
        ------
        1. system_param: dict
    ...
    def initialize(self, psi_ket, psi_bra):
        """
