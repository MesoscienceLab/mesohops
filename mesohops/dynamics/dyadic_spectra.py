...
from mesohops.dynamics.hops_dyadic import DyadicTrajectory
...
class DyadicSpectra(DyadicTrajectory):
    ...
    def calculate_spectrum(self):
        ...
        if self.spectrum_type == "ABSORPTION":
            ...
            self.propagate(self.t_1, self.t_step)
        ...
        # ==============================
            ...
            self.propagate(self.t_2, self.t_step)
            ...
            self.propagate(self.t_3, self.t_step)
...
def prepare_chromophore_input_dict(M2_mu_ge, H2_sys_hamiltonian, bath_dict):
    ...
    for key, value in list(bath_dict.items()):
        ...
        elif (key is not "nmodes_LTC") and (value is None or value == 0):
            del bath_dict[key]
