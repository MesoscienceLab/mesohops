import pytest
import numpy as np
from mesohops.dynamics.dyadic_spectra import DyadicSpectra as DHOPS
from mesohops.dynamics.dyadic_spectra import (prepare_spectroscopy_input_dict,
                                            prepare_chromophore_input_dict,
                                            prepare_convergence_parameter_dict)
from mesohops.dynamics.bath_corr_functions import ishizaki_decomposition_bcf_dl
...
def test_initialize(capsys):
    ...
    assert dhops_adaptive.basis.eom.param["DELTA_H"] == 1e-10
