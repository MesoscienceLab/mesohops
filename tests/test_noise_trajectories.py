...
from mesohops.noise.noise_trajectories import NumericNoiseTrajectory
...
noise_corr = {
    ...
    "NMODE_BY_LIND": sys_param["NMODE_BY_LIND"],
...
noise_obj._prepare_noise(np.arange(sys_param["N_L2"]))
