...
def test_LTC_non_adaptive_nonlinear_norm_eom():
    ...
    list_l_op_exp = [np.conj(psi_0)@l_op@psi_0/(np.conj(psi_0)@psi_0) for l_op in
                     list_l_op]
    list_l_op = [sp.sparse.csr_array(l_op) for l_op in list_l_op]
...
def test_LTC_adaptive_nonlinear_norm_eom():
    ...
    list_l_op_reduced = [sp.sparse.csr_array(l_op) for l_op in list_l_op_reduced]
    ...
    list_l_op_reduced_adap = [sp.sparse.csr_array(l_op) for l_op in list_l_op_reduced_adap]
